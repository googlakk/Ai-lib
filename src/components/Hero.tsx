      ...
      <div className="container mx-auto px-4 text-center text-white relative z-10">
        <div className="animate-fade-in">
          <div className="flex items-center justify-center gap-2 mb-6">
            ...
            <span className="text-ai-secondary font-semibold text-lg">AI для образования</span>
          </div>
          
          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
            Каталог <span className="text-ai-secondary">AI-сервисов</span><br />
            для учителей
          </h1>
          
          <p className="text-xl md:text-2xl mb-8 text-blue-100 max-w-3xl mx-auto leading-relaxed">
            Откройте для себя лучшие инструменты искусственного интеллекта, 
            которые помогут сделать ваши уроки более интерактивными и эффективными
          </p>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 animate-slide-up">
          <div className="text-center">
            <div className="text-3xl font-bold text-ai-secondary mb-2">50+</div>
            <div className="text-blue-100">AI-сервисов</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-bold text-ai-secondary mb-2">15+</div>
            <div className="text-blue-100">Предметных областей</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-bold text-ai-secondary mb-2">1000+</div>
            <div className="text-blue-100">Довольных учителей</div>
          </div>
        </div>
      </div>
    </section>
