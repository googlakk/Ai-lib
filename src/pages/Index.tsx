          ...
          <div className="container mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-foreground mb-4">
                Каталог AI-сервисов Intellect Pro School
              </h2>
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Внутренние инструменты искусственного интеллекта для преподавателей нашей школы
              </p>
            </div>
        ...
        <section className="py-16 px-4 bg-gradient-hero">
          <div className="container mx-auto text-center text-white">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Есть предложения по новым AI-инструментам?
            </h2>
            <p className="text-xl mb-8 text-blue-100 max-w-2xl mx-auto">
              Свяжитесь с IT-отделом Intellect Pro School для добавления новых сервисов в каталог
            </p>
            <div className="bg-white/10 rounded-lg p-6 max-w-md mx-auto">
              <p className="text-sm mb-4">
                Доступ к админ-панели предоставляется только сотрудникам IT-отдела школы
              </p>
              <div className="text-ai-secondary text-sm">
                🏫 Intellect Pro School • 🇰🇬 Бишкек • 💡 Инновации в образовании
              </div>
            </div>
          </div>
        </section>
